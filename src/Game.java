...
public abstract class Game extends JFrame {
	...
	/**
	 * <code>true</code> if the original doodle is chosen
	 */
	private boolean originalD = false;
	/**
	 * <code>true</code> if the carrot doodle is chosen
	 */
	private boolean carrotD = false;
	/**
	 * <code>true</code> if the hawaiian doodle is chosen
	 */
	private boolean hawaiianD = false;
	/**
	 * <code>true</code> if the sports doodle is chosen
	 */
	private boolean sportsD = false;
	/**
	 * <code>true</code> if the sleepy doodle is chosen
	 */
	private boolean sleepyD = false;
	/**
	 * <code>true</code> if the angel doodle is chosen
	 */
	private boolean angelD = false;
	/**
	 * <code>true</code> if a player has been chosen
	 */
	...
	/**
	 * Returns <code>true</code> if the '1' key is being pressed down
	 * 
	 * @return <code>true</code> if the '1' key is being pressed down
	 */
	...
	/**
	 * Returns <code>true</code> if the '2' key is being pressed down
	 * 
	 * @return <code>true</code> if the '2' key is being pressed down
	 */
	public boolean key2Pressed() {
		playerChosen = true;
		return carrotD;
	}
	/**
	 * Returns <code>true</code> if the '3' key is being pressed down
	 * 
	 * @return <code>true</code> if the '3' key is being pressed down
	 */
	public boolean key3Pressed() {
		playerChosen = true;
		return hawaiianD;
	}
	/**
	 * Returns <code>true</code> if the '4' key is being pressed down
	 * 
	 * @return <code>true</code> if the '4' key is being pressed down
	 */
	public boolean key4Pressed() {
		playerChosen = true;
		return sportsD;
	}
	/**
	 * Returns <code>true</code> if the '5' key is being pressed down
	 * 
	 * @return <code>true</code> if the '5' key is being pressed down
	 */
	public boolean key5Pressed() {
		playerChosen = true;
		return sleepyD;
	}
	/**
	 * Returns <code>true</code> if the '6' key is being pressed down
	 * 
	 * @return <code>true</code> if the '6' key is being pressed down
	 */
	public boolean key6Pressed() {
		playerChosen = true;
		return angelD;
	}
	/**
	 * Returns <code>true</code> if key 1-6 is being pressed down
	 * 
	 * @return <code>true</code> if key 1-6 is being pressed down
	 */
	public boolean playerKeyPressed() {
		return playerChosen;
	}
       ...
       addKeyListener(new KeyListener() {	
			public void keyPressed(KeyEvent e) {
				...
				switch (pressed) {
					...
					case '1' : originalD = true; break;
					case '2' : carrotD = true; break;
					case '3' : hawaiianD = true; break;
					case '4' : sportsD = true; break;
					case '5' : sleepyD = true; break;
					case '6' : angelD = true; break;
				}
			}
			...
			public void keyReleased(KeyEvent e) {
				...
				switch (released) {
					...
					case 'S' : start = false; break;
					case '1' : originalD = false; break;
					case '2' : carrotD = false; break;
					case '3' : hawaiianD = false; break;
					case '4' : sportsD = false; break;
					case '5' : sleepyD = false; break;
					case '6' : angelD = false; break;
				}
			}
